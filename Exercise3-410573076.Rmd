...
params:
  studentID: "410573076"
  studentName: "陳盈蓁"
  repoURL: "https://github.com/Chen-Ying-Chen/inclassPractice1/blob/master/Exercise3-410573076.Rmd"
---
...
```{r ans13}
classData[classData$`公-10-06`=="有看公告"&classData$`練2018-10-17-1`=="1",]
nrow(classData[classData$`公-10-06`=="有看公告",]) -> Peoplereadthebulletin
nrow(classData[classData$`公-10-06`=="有看公告"&classData$`練2018-10-17-1`=="1",]) -> Peoplereadthebulletinandcommit
Peoplereadthebulletinandcommit/Peoplereadthebulletin
```
...
```{r ans14}
classData[classData$`公-10-06`=="沒看公告"&classData$`練2018-10-17-1`=="1",]
nrow(classData[classData$`公-10-06`=="沒看公告",]) -> Peopledidnotreadthebulletin
nrow(classData[classData$`公-10-06`=="沒看公告"&classData$`練2018-10-17-1`=="1",]) -> Peopledidnotreadthebulletinbutcommit
Peopledidnotreadthebulletinbutcommit/Peopledidnotreadthebulletin
```
...
```{r ans21}
library(lubridate)
with_tz(mdy_hms(hwData$Timestamp), "Asia/Taipei") -> hwData$Timestamp
```
...
```{r ans22}
ymd_hms("2018-10-24 00:00:00") -> deadline
```
